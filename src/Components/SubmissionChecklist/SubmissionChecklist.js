	...
	const [checked, setChecked] = useState([
		{
			...
			checked: false,
			text:
				'1) Click the "Share" button in the upper righthand corner of your document.',
			imgUrl:
		...
		},
		{
			number: 2,
			checked: false,
			text: '2) Select "Change" underneath the "Get link" icon.',
			imgUrl:
		...
		},
		{
			...
			checked: false,
			text:
				'3) Click the arrow and choose "Commenter" from the list so that your editor can leave comments and suggestions on your document.',
			imgUrl:
		...
		},
		{
			...
			checked: false,
			text:
				'4) Click "Done" below the dropdown list, and click "Copy link" to the right of the green box to copy your shareable link to the clipboard. Return to red ink to share your link with your editor!',
			imgUrl:
